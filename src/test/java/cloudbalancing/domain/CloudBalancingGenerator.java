...
public class CloudBalancingGenerator {
    private final Logger logger = LoggerFactory.getLogger(CloudBalancingGenerator.class);
    ...
    public CloudBalance createCloudBalance(String inputId, int computerListSize, int processListSize) {
        ...
        System.out.println("CloudBalance "+  inputId + " has " + computerListSize + " computers and " + processListSize + " processes with a search space of." + possibleSolutionSize);
        return cloudBalance;
    }
    ...
    public CloudComputer generateComputer(long id) {
        ...
        CloudComputer computer = new CloudComputer(id, CPU_POWER_PRICES[cpuPowerPricesIndex].getHardwareValue(),
                ...
                cost);
        System.out.println("Created computer with cpuPowerPricesIndex (" + cpuPowerPricesIndex + "), memoryPricesIndex ("+
                        memoryPricesIndex +")," + " networkBandwidthPricesIndex ("+ networkBandwidthPricesIndex + ").");
        return computer;
    }
